...
C2DSprite::C2DSprite()
{
	...
	// 此處改成正面為面向正 Z 方向 
	m_pPoints[0] = vec4( -2.5f, 0.0f, 0.0f, 1.0f);
	m_pPoints[1] = vec4( -1.5f, 0.0f, 0.0f, 1.0f);
	m_pPoints[2] = vec4( -4.0f,  5.0f, 0.0f, 1.0f);
	m_pPoints[3] = vec4(1.5f, 0.0f, 0.0f, 1.0f);
	m_pPoints[4] = vec4(2.5f, 0.0f, 0.0f, 1.0f);
	m_pPoints[5] = vec4(4.0f,  5.0f, 0.0f, 1.0f);
