...
// 
// 執行前的準備工作 
//  CShape.h 的 17 到 25 行， 僅打開第 22 行(如下的)，其他都設定成註解
...
void init( void )
{
	...
	g_pFloor->SetTiling(1, 1); // 原始為 (10, 10)
	...
	g_LeftWall->SetTiling(5, 5); // 原始為 (10, 10)
	...
	g_RightWall->SetTiling(5, 5); // 原始為 (10, 10)
	...
	g_FrontWall->SetTiling(5, 5); // 原始為 (10, 10)
	...
	g_BackWall->SetTiling(5, 5); // 原始為 (10, 10)
	...
	g_pLight->SetTextureLayer(0);		// 沒有貼圖
